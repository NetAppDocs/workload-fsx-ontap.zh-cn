...
keywords: overview 
summary: FSx for ONTAP支持快照、具有 AI 的NetApp Autonomous Ransomware、卷复制以及NetApp Workload Factory 中的备份。 
---
= NetApp Workload Factory 中的数据保护类型
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* 使用卷复制进行灾难恢复：如果您的应用程序需要较低的 RTO，请考虑使用卷复制将您的数据复制到另一个区域。
