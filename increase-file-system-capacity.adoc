...
---
= 在 NetApp Workload Factory 中手动调整文件系统容量
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
当使用量超过指定阈值时，增加 SSD 存储容量。当您不使用工作集以节省资金时，降低 SSD 存储容量。

或者，您可以link:manage-capacity-automatically.html["启用自动容量管理"]，以便 Workload Factory 为您管理文件系统容量。
