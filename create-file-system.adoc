...
* 具有创建和删除文件系统权限的凭据，用于创建ONTAP文件系统的 FSx。link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["了解如何为AWS帐户授予权限"^]。
