...
.开始之前
为了使 Workload Factory 能够检测您 AWS 账户中的 Amazon Elastic Block Store (EBS)、Elastic File System (EFS) 和 FSx for Windows File Server 存储环境，请确保link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["授予只读权限"^]在您的 AWS 账户中。
