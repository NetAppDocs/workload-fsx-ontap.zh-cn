...
summary: 编辑快照设置、启用目录访问和删除快照以管理 Workload Factory 中的快照和数据保护。 
---
...
[role="lead"]
编辑快照设置、启用目录访问和删除快照以管理 Workload Factory 中的快照和数据保护。
...
. 从“*Volumes*”选项卡中，选择要编辑快照的卷的操作菜单。
. 选择*数据保护操作*，然后选择*管理快照*。
. 在“管理快照”页面中，选择要编辑的快照的操作菜单，然后选择“*编辑*”。
. 在编辑快照对话框中，您可以编辑以下内容：
+
.. 更改名称。
.. 更改标签。
...
. 从 *FSx for ONTAP* 中，选择带有卷的文件系统的操作菜单，然后选择 *管理*。
. 在文件系统概述中，选择*Volumes*选项卡。
. 从“*Volumes*”选项卡中，选择要访问的快照的卷的操作菜单。
. 选择*数据保护操作*，然后选择*管理快照*。
. 从管理快照页面中，选择要访问的快照的操作菜单，然后选择*访问*。
...
. 从 *FSx for ONTAP* 中，选择带有卷的文件系统的操作菜单，然后选择 *管理*。
. 在文件系统概述中，选择*Volumes*选项卡。
. 从“*Volumes*”选项卡中，选择要删除快照的卷的操作菜单。
. 选择*数据保护操作*，然后选择*管理快照*。
. 在管理快照页面中，选择要删除的快照的操作菜单，然后选择*删除*。
. 在删除快照对话框中，输入“delete”。
. 选择*删除*确认删除。
